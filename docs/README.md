...
Welcome to the Cofu documentation.
If you're just getting started with Cofu, please start to read [Getting Started](getting-started.md).
...
* [Resources](resources.md)
    ...
    * [remote_directory](resources_remote_directory.md)
